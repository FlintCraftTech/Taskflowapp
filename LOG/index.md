...
- [HASH] — /plan: committed to the navigation-spine redesign — promoted the right half to a new spec-edit batch [nav-spine-spec-edit] at the top of Build (rewrites SPEC principle 3 + §Schedule view + §Side menu + §Strategy doc into the spine, adds a Projects overview spine page, absorbs held trim findings F3/F4/F18, moves the Strategy-doc menu row to after the projects list), reframed the 0002/0003/0004 summaries as spine work, and re-parked the left half (completed-history) as [nav-completed-history] (was [nav-zoom-spine-and-completed-history]). → plan-2026-06-17-2.md
