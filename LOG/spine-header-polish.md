# 5b68c5f — ScheduleScreen.kt — fixed the spine-title overlap during page transitions (slides now overlap with a crossfade instead of colliding mid-slide) and replaced the text-glyph chevron arrows with vertically-centred Material KeyboardArrowLeft/Right icons
